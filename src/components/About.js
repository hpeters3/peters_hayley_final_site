        ...
        <section id="about">
            <div className ="flex px-10 py-20 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:text-left mb-16 md:mb-0 text-center">
                    ...
                    <a href="mailto:8hayleypeters6@gmail.com" className="inline-flex text-white bg-green-500 py-2 px-6 focus:outline-nonehover:bg-green-600 rounded text-lg">Contact Me</a>
