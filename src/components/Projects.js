...
//title, description, image, link, tech list

export default function Projects() {
    return(
        <section id="projects">
            <div className="container px-5 py-10 mx-auto text-center l:px-40">
                <div className="flex flex-col w-full mb-20">
                    <CodeIcon className="mx-auto inline-block w-10 mb-4"/>
                    <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-white">Applications I've Built</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Some text here explaining something.</p>
                </div>
                        ...
                        <a href={project.link} key={project.image} className="sm:w-1/2 w-100 p-4">
                            <div className="flex relative">
                                ...
                                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                    ...
                                    <p className="leadng-relaxed">{project.description}</p>
                                </div>
                            </div>
                        </a>
                    ))}
